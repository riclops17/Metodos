...
public class Metodos {
    ...
    double[] terminosIndep;      //términos independientes
    public double[] polinomio; //polinomio   a[0]+a[1]·x+a[2]·x2+...
...
// meetodo que muestra el polinomio por pantalla 
...
// metodo que calcula la aproximacion del polinomio
...
class prueba {
    ...
    public static void main(String[] args) {
        double[] x = {-50,-20,10,70, 100, 120};
        double[] y = {0.125, 0.128, 0.134 ,0.144 ,0.150 ,0.155};
        int punto;
